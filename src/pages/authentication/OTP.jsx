...
const OTP = () => {
  ...
  return (
    <div className='flex justify-center inter bg-[#fcfeff] h-[100vh] '>
      
<div className='grid grid-cols-2 gap-10 py-10  place-items-center '>
   
   {/* agrio */}
    <div className='w-[575px] pt-6 h-[550px] flex flex-col gap-3 justify-center items-center  bg-[#F0F2F5]'>
