...
function Side({ picture, userName }) {
  ...
  return (
    <>
      ...
      <div
        className="hidden lg:inline-block bg-[#02402D]
        ...
        <ul className="flex flex-col mt-5 font-bold space-y-2 px-2">
          {currentNavItems.map((item, index) => (
            <Link
              key={index}
              to={item.path}
              className={`flex items-center py-2 px-2 space-x-4 rounded-lg ${
              ...
              <div className="top flex">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-[#344054]">
                    Update your details to keep your account accurate and
                    accessible.
                  </p>
                </div>
              </div>
