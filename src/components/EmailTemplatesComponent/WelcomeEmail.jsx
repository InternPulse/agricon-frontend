    ...
    <section className="flex flex-col min-h-screen justify-center items-center bg-[#F7F7F7] px-4 py-8 addFont">
      <div className="w-full max-w-[600px]  rounded-[32px] bg-white shadow-md p-6 md:p-8 lg:p-[32px] flex flex-col justify-between">
        ...
        <div className="mt-8 space-y-4">
          ...
          {/* Footer */}
          <p className="text-[14px] md:text-[16px]  font-normal leading-[22px] mt-4">
        ...
        {/* Button */}
        <div className="mt-8">
          <button className="bg-[#02402D]  w-full md:w-[173px] h-[48px] md:h-[56px] text-white text-[14px] md:text-[16px] font-medium px-6 py-2 rounded-full transition cursor-pointer">
            Open Agricon
          </button>
        </div>
      </div>
