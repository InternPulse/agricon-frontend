      ...
      <div className="w-full max-w-[600px] rounded-[32px] bg-white shadow-md p-6 md:p-8 lg:p-[32px] flex flex-col justify-between">
        ...
        <div className="mt-8 space-y-8 md:space-y-12">
          <div className="space-y-4 md:space-y-5">
            <h1 className="text-[20px] md:text-[24px]  font-semibold leading-tight">
              Forgot Your Password?
            </h1>
            <h2 className="text-[20px] md:text-[24px]  font-medium leading-tight">
              No worries — let's get you back in.
            </h2>
            <p className="text-[14px] md:text-[16px]  leading-snug font-normal">
              Hi Tolulope,
            </p>
            <p className="text-[14px] md:text-[16px]  leading-snug font-normal">
          ...
          {/* button */}
          <div>
            <button className="bg-[#02402D] h-[48px] md:h-[56px] w-full md:w-[191px]  text-white text-[14px] md:text-[16px] font-medium px-6 py-2 rounded-full transition cursor-pointer">
              Reset Password
            </button>
          </div>
        </div>
